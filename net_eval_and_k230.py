...
def init_model(args):
    ...
    if "model" in args.load_from:
        ...
        # 替换self_attention -> self_attn
        new_state_dict = {}
        for key, value in state_dict.items():
            new_key = key.replace("self_attention", "self_attn") if "self_attention" in key else key
...
def main():
    ...
    parser.add_argument("--weight", default="m_pretrain", type=str, help="权重前缀")
